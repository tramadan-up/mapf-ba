...
dest1 = "./solution/all_cnc/combined_instance.lp"                       # temporary file: instance
dest2 = "./solution/all_cnc/combined_prep.lp"                           # temporary file: preparation
dest3 = "./solution/all_cnc/prep.lp"                                    # processed instance
dest4 = "./solution/all_cnc/plan.lp"                                    # solution
