...
dest1 = "./solution/group_cnc/combined_instance.lp"                       # temporary file: instance
dest2 = "./solution/group_cnc/combined_prep.lp"                           # temporary file: preparation
dest3 = "./solution/group_cnc/prep.lp"                                    # processed instance
dest4 = "./solution/group_cnc/plan.lp"                                    # solution
